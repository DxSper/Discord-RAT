<h1 align="center">:snake: Discord-RAT</h1>

<p align="center">
  Control computer via Discord & Telegram!
</p>

# :page_facing_up: Installation guide for Discord !
...
* Create a bot in discord via [Discord Develloper Portal](https://discord.com/developers/applications), after which find its Token

  <img src="https://i.imgur.com/ZvIyGI9.png">

* Now you need to get your Discord-ID. To do this, go on [DiscordClient] and save your identifier.

  <img src="https://i.imgur.com/wKJOoaG.png">
...
# :page_facing_up: Installation guide for telegram !
* For the script to work, install Python and download files from the repository
  * Go to the `Modules` directory and run `Requirements.bat` to install the necessary modules
